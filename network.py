...
def model_config():
    ...
    data_arg.add_argument("--data_prefix", type=str, default="cli")
    ...
    net_arg.add_argument("--embed_size", type=int, default=768)
    ...
    train_arg.add_argument("--num_epochs", type=int, default=15)
    ...
    misc_arg.add_argument("--valid_steps", type=int, default=700)
